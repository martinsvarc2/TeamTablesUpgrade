              ...
              <thead className="sticky top-0 z-10">
                <tr className="bg-[#f8b922]">
                  ...
                  <th className="w-64 px-4 py-4">
                    <div className="flex items-center justify-center text-sm font-medium text-white -ml-4">
                      User
                    </div>
                  </th>
                  ...
                  <th className="w-[380px] px-4 py-4 text-center text-sm font-medium text-white">
                    Call Recording
                  </th>
                </tr>
              </thead>
